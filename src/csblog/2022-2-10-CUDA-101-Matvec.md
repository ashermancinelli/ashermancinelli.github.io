...
- [CUDA 101: Matrix-Vector Product](#cuda-101-matrix-vector-product)
- [Key Takeaways](#key-takeaways)
- [Outline](#outline)
- [Mathematical Understanding of Algorithm](#mathematical-understanding-of-algorithm)
- [Algorithm Analysis](#algorithm-analysis)
- [C on the Host](#c-on-the-host)
- [CUDA C](#cuda-c)
  - [Core Concepts](#core-concepts)
    - [Host and Device](#host-and-device)
    - [Using the CUDA Runtime](#using-the-cuda-runtime)
    - [Shared Memory](#shared-memory)
    - [CUDA Mat-Vec Multiply](#cuda-mat-vec-multiply)
- [CUDA C++](#cuda-c-1)
  - [Naive Approach](#naive-approach)
  - [More Sophisticated Approach](#more-sophisticated-approach)
  - [The Best Tool for the Job](#the-best-tool-for-the-job)
- [Conclusion](#conclusion)
- [BQN Example](#bqn-example)
- [Links, References, Additional Reading](#links-references-additional-reading)
